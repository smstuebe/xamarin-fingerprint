...
var solutionName = "Fingerprint";
var repoName = "smstuebe/xamarin-fingerprint";
var sln = new FilePath("./src/" + solutionName + ".sln");
...
var releaseNotesUrl = "https://github.com/smstuebe/xamarin-fingerprint/blob/master/doc/changelog.md";
    ...
    .Does(() => 
{
    ...
    var patchedReleaseNotesUrl = releaseNotesUrl.Replace("master", versionInfo.BranchName);

    XmlPoke(buildProp, "//Project/PropertyGroup/Version", versionInfo.SemVer);
    XmlPoke(buildProp, "//Project/PropertyGroup/PackageReleaseNotes", patchedReleaseNotesUrl);
});
    ...
    .Does(() => 
{
    ...
    foreach(var file in files)
    {
        ...
        var arguments = new ProcessArgumentBuilder()
            ...
            .AppendSwitchQuoted("-n", "Fingerprint")
            .AppendSwitchQuoted("-d", "Xamarin and MvvmCross plugin for authenticate a user via fingerprint sensor")
            .AppendSwitchQuoted("-u", "https://github.com/smstuebe/xamarin-fingerprint");
