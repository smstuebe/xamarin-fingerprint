...
namespace Plugin.Fingerprint.Dialog
{
    public class FingerprintSecureValueDialogFragment : DialogFragment, IAuthenticationFailedListener, IDialogInterfaceOnKeyListener
    {
        ...
        private bool _cancelledByLifecycle;
        ...
        public async Task<AuthenticationCallbackResult> ShowAsync(
            AuthenticationRequestConfiguration config,
            TaskCompletionSource<AuthenticationCallbackResult> resultTaskCompletionSource,
            CancellationToken cancellationToken)
        {
            Configuration = config;
            _resultTaskCompletionSource = resultTaskCompletionSource;         
        ...
        private async void Dismiss(AuthenticationCallbackResult result)
        {            
            DetachEventHandlers();
        ...
        {
            SetManualResult(FingerprintAuthenticationResultStatus.Cancelled, false);
        }
        ...
        {
            SetManualResult(FingerprintAuthenticationResultStatus.Cancelled);
        }
        ...
        private async Task AnimateResultAsync(FingerprintAuthenticationResultStatus status)
        {
            switch (status)
            {
                ...
                case FingerprintAuthenticationResultStatus.Cancelled:
